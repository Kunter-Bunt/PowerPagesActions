...
{
    public abstract class PluginBase<T> : PluginBase where T : Entity
    {
        public PluginBase(Type pluginClassName) : base(pluginClassName)
        {
        ...
        protected override void ExecuteDataversePlugin(ILocalPluginContext localPluginContext)
        {
            ...
            if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
            {
                ...
                ExecutePlugin(localPluginContext, typedEntity);
            }
            else
                localPluginContext.Trace("No target!");
        }

        protected abstract void ExecutePlugin(ILocalPluginContext localPluginContext, T target);
    }
