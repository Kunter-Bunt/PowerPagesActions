...
namespace PowerPagesCustomApiAdapter.EarlyBounds
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		public System.Linq.IQueryable<PowerPagesCustomApiAdapter.EarlyBounds.MwO_PowerPagesAction> MwO_PowerPagesActionSet
		{
			get
			{
				return this.CreateQuery<PowerPagesCustomApiAdapter.EarlyBounds.MwO_PowerPagesAction>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="PowerPagesCustomApiAdapter.EarlyBounds.MwO_PowerPagesActionConfiguration"/> entities.
		/// </summary>
		public System.Linq.IQueryable<PowerPagesCustomApiAdapter.EarlyBounds.MwO_PowerPagesActionConfiguration> MwO_PowerPagesActionConfigurationSet
		{
			get
			{
